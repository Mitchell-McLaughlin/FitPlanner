...
public class ToolDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(ToolDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(ToolDetailFragment.ARG_ITEM_ID));
            ToolDetailFragment fragment = new ToolDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.tool_detail_container, fragment)
                    .commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, ToolListActivity.class));
            return true;
        }
