...
import mactech.fitplanner.dummy.DummyContent;
...
public class ToolListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.tool_list);
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.tool_list_content, parent, false);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(ToolDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(ToolDetailFragment.ARG_ITEM_ID, holder.mItem.id);
